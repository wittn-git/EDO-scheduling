...
std::function<std::vector<T>(const std::vector<T>&, std::mt19937&)> select_random(int parent_count) {
    return [parent_count](const std::vector<T>& genes, std::mt19937& generator) -> std::vector<T> {
